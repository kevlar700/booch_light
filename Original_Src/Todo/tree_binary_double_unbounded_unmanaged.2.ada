...
package body Tree_Binary_Double_Unbounded_Unmanaged is
    ...
    begin
        if From_The_Tree = null then
            ...
            To_The_Tree := new Node'(Previous => null,
                                     The_Item => From_The_Tree.The_Item,
                                     Left_Subtree => null,
                                     Right_Subtree => null);
    ...
    begin
        if And_The_Tree = null then
            And_The_Tree := new Node'(Previous => null,
                                      The_Item => The_Item,
                                      Left_Subtree => null,
                                      Right_Subtree => null);
            ...
            if On_The_Child = Left then
                And_The_Tree := new Node'(Previous => null,
                                          ...
                                          Right_Subtree => null);
                And_The_Tree.Left_Subtree.Previous := And_The_Tree;
            else
                And_The_Tree := new Node'(Previous => null,
                                          The_Item => The_Item,
                                          Left_Subtree => null,
                                          Right_Subtree => And_The_Tree);
                And_The_Tree.Right_Subtree.Previous := And_The_Tree;
            end if;
        else
            raise Not_At_Root;
        end if;
...
end Tree_Binary_Double_Unbounded_Unmanaged;
