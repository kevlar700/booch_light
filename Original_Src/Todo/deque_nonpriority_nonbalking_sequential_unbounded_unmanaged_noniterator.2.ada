...
package body Deque_Nonpriority_Nonbalking_Sequential_Unbounded_Unmanaged_Noniterator is
...
end Deque_Nonpriority_Nonbalking_Sequential_Unbounded_Unmanaged_Noniterator;
