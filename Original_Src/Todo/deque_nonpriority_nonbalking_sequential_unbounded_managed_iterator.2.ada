...
package body Deque_Nonpriority_Nonbalking_Sequential_Unbounded_Managed_Iterator is
...
end Deque_Nonpriority_Nonbalking_Sequential_Unbounded_Managed_Iterator;
