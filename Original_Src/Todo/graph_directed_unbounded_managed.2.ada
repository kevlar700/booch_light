...
package body Graph_Directed_Unbounded_Managed is
    ...
    package Vertex_Manager is
       new Storage_Manager_Sequential (Item => Vertex_Node,
                                       Pointer => Vertex,
                                       Free => Free,
    ...
    package Arc_Manager is
       new Storage_Manager_Sequential (Item => Arc_Node,
                                       Pointer => Arc,
                                       Free => Free,
                                       Set_Pointer => Set_Next,
                                       Pointer_Of => Next_Of);
    ...
    package Vertex_Map is
       new Map_Simple_Noncached_Sequential_Unbounded_Managed_Iterator
              (Domain => Vertex,
               Ranges => Vertex,
               Number_Of_Buckets => 1,
               Hash_Of => Hash_Of);
    ...
    begin
        if (From_The_Vertex = Null_Vertex) or else
           (To_The_Vertex = Null_Vertex) then
            ...
            The_Arc.The_Source := From_The_Vertex;
            The_Arc.The_Destination := To_The_Vertex;
...
end Graph_Directed_Unbounded_Managed;
