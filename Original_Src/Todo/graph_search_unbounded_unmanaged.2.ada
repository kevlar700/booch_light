...
with Set_Simple_Sequential_Unbounded_Unmanaged_Noniterator,
     Stack_Sequential_Unbounded_Unmanaged_Noniterator,
     Queue_Nonpriority_Nonbalking_Sequential_Unbounded_Unmanaged_Noniterator;
package body Graph_Search_Unbounded_Unmanaged is

    package Vertex_Set is
       new Set_Simple_Sequential_Unbounded_Unmanaged_Noniterator
              (Item => Vertex);

    package Vertex_Stack is
       new Stack_Sequential_Unbounded_Unmanaged_Noniterator (Item => Vertex);

    package Vertex_Queue is
       new Queue_Nonpriority_Nonbalking_Sequential_Unbounded_Unmanaged_Noniterator
              (Item => Vertex);
...
end Graph_Search_Unbounded_Unmanaged;
