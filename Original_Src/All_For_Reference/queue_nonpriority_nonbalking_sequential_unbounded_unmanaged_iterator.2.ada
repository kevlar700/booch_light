...
package body Queue_Nonpriority_Nonbalking_Sequential_Unbounded_Unmanaged_Iterator is
    ...
    begin
        The_Queue := Queue'(The_Front => null, The_Back => null);
    end Clear;
...
end Queue_Nonpriority_Nonbalking_Sequential_Unbounded_Unmanaged_Iterator;
