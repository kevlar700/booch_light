...
generic
    ...
    with procedure Free        (The_Item    : in out Item);
    with procedure Set_Pointer (The_Item    : in out Item; 
                                The_Pointer : in     Pointer);
    with function Pointer_Of (The_Item : in Item) return Pointer;
package Storage_Manager_Concurrent is
