...
package body Deque_Priority_Nonbalking_Sequential_Unbounded_Unmanaged_Iterator is
...
end Deque_Priority_Nonbalking_Sequential_Unbounded_Unmanaged_Iterator;
