...
package body Fixed_Point_Utilities is
    ...
    function Real_Image (The_Fraction : in Number; 
        ...
        Result : Number := Number (The_Fraction * Number (With_The_Base));
    begin
        if The_Length = 0 then
            return "";
        else
            return (Character_Utilities.Image_Of (Integer_Part (Result)) & 
                    Real_Image (Real_Part (Result), With_The_Base, 
                                (The_Length - 1)));
        end if;
    end Real_Image;
    ...
    function Image_Of (The_Number : in Number; With_The_Base : in Base := 10) 
        ...
        The_String : constant String := 
           Utilities.Image_Of (Integer_Part (The_Number), 
    ...
    function "**" (The_Number : in Number; The_Power : in Integer) 
                  return Number is
        Result : Number := 1.0;
    begin
        ...
        if Radix_Point = 0 then
            ...
            if The_Power = 0 then
                ...
                for Index in reverse (Radix_Point + 1) .. The_Image'Last loop
                    Result := Result + (Number (Value_Of (The_Image (Index), 
                                                          With_The_Base) * 
                                                (Number (With_The_Base) ** 
                                                 The_Power)));
                ...
                if (The_Image (The_Image'First) = Blank) or 
                   (The_Image (The_Image'First) = Plus) then
                    ...
                    Result := Result + 
                                 (Number (Value_Of (The_Image (The_Image'First), 
                                                    With_The_Base) * 
                                          (Number (With_The_Base) ** 
                                           The_Power)));
                    return Result;
