...
package body Map_Discrete_Noncached_Sequential_Bounded_Managed_Iterator is
        ...
        for The_Iterator in Over_The_Map'Range loop
            if Over_The_Map (The_Iterator).Is_Bound then
                Process (The_Iterator,
                         Over_The_Map (The_Iterator).The_Range, Continue);
            end if;
        end loop;
    end Iterate;

end Map_Discrete_Noncached_Sequential_Bounded_Managed_Iterator;
