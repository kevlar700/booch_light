...
with Set_Simple_Sequential_Unbounded_Controlled_Noniterator,
     Stack_Sequential_Unbounded_Controlled_Noniterator,
     Queue_Nonpriority_Nonbalking_Sequential_Unbounded_Controlled_Noniterator;
package body Graph_Search_Unbounded_Controlled is

    package Vertex_Set is
       new Set_Simple_Sequential_Unbounded_Controlled_Noniterator
              (Item => Vertex);

    package Vertex_Stack is
       new Stack_Sequential_Unbounded_Controlled_Noniterator (Item => Vertex);

    package Vertex_Queue is
       new Queue_Nonpriority_Nonbalking_Sequential_Unbounded_Controlled_Noniterator
              (Item => Vertex);
...
end Graph_Search_Unbounded_Controlled;
