...
package Graph_Undirected_Unbounded_Managed is
...
private
    ...
    package Vertex_Set is
      new Set_Simple_Sequential_Unbounded_Managed_Iterator (Item => Vertex);
    type Arc_Node;
    type Arc is access Arc_Node;
    package Arc_Set is
      new Set_Simple_Sequential_Unbounded_Managed_Iterator (Item => Arc);
    type Graph is
        record
