...
package Stack_Guarded_Unbounded_Unmanaged_Noniterator is

    type Stack is limited private;

    procedure Seize   (The_Stack      : in     Stack);
    procedure Release (The_Stack      : in     Stack);
...
end Stack_Guarded_Unbounded_Unmanaged_Noniterator;
