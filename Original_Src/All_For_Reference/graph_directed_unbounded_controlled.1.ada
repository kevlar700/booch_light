...
package Graph_Directed_Unbounded_Controlled is
...
private
    ...
    package Vertex_Set is
      new Set_Simple_Sequential_Unbounded_Controlled_Iterator (Item => Vertex);
    type Arc_Node;
    type Arc is access Arc_Node;
    package Arc_Set is
      new Set_Simple_Sequential_Unbounded_Controlled_Iterator (Item => Arc);
    type Graph is
        record
...
end Graph_Directed_Unbounded_Controlled;
