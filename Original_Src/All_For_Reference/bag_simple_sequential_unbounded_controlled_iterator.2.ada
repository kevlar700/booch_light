...
package body Bag_Simple_Sequential_Unbounded_Controlled_Iterator is
    ...
    procedure Set_Next (The_Node : in out Node; To_Next : in Bag) is
    begin
...
end Bag_Simple_Sequential_Unbounded_Controlled_Iterator;
