...
package Deque_Nonpriority_Balking_Sequential_Unbounded_Controlled_Noniterator is
    ...
    function Position_Of (The_Item     : in Item; 
                          In_The_Deque : in Deque) return Natural;
...
end Deque_Nonpriority_Balking_Sequential_Unbounded_Controlled_Noniterator;
