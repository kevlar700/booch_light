...
package body Shell_Sort is
    ...
    begin
        ...
        loop
            for Outer_Index in Index'Val
                                  (Index'Pos (The_Items'First) + Increment) ..
                                  The_Items'Last loop
                Temporary_Item := The_Items (Outer_Index);
                Inner_Index := Outer_Index;
                while Temporary_Item <
                         The_Items (Index'Val (Index'Pos (Inner_Index) -
                                               Increment)) loop
                    The_Items (Inner_Index) :=
                       The_Items (Index'Val
                                     (Index'Pos (Inner_Index) - Increment));
                    Inner_Index := Index'Val
                                      (Index'Pos (Inner_Index) - Increment);
                    exit when (Index'Pos (Inner_Index) - Increment <
