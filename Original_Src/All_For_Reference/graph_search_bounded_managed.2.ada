...
with Set_Simple_Sequential_Bounded_Managed_Noniterator,
     Stack_Sequential_Bounded_Managed_Noniterator,
     Queue_Nonpriority_Nonbalking_Sequential_Bounded_Managed_Noniterator;
package body Graph_Search_Bounded_Managed is

    package Vertex_Set is
       new Set_Simple_Sequential_Bounded_Managed_Noniterator (Item => Vertex);

    package Vertex_Stack is
       new Stack_Sequential_Bounded_Managed_Noniterator (Item => Vertex);
    ...
    procedure Traverse_Depth_First
                 (From_The_Vertex : in Vertex; In_The_Graph : in Graph) is
        The_Size : Natural := Number_Of_Vertices_In (In_The_Graph);
...
end Graph_Search_Bounded_Managed;
