    ...
    procedure Sort (The_Items : in out Items) is
        ...
        begin
            if Right_Index > Left_Index then
                ...
                loop
                    while (not Bit_Of (The_Items (Temporary_Left), Bit)) and
                             (Temporary_Left < Temporary_Right) loop
                        Temporary_Left := Index'Succ (Temporary_Left);
                    end loop;
                    while (Bit_Of (The_Items (Temporary_Right), Bit)) and
                             (Temporary_Left < Temporary_Right) loop
