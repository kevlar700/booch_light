...
generic
    ...
    with procedure Construct (The_Item     : in     Item; 
...
package List_Utilities_Single is
    ...
    procedure Construct   (The_Items          : in     Items; 
                           And_The_List       : in out List);
    procedure Construct   (The_List           : in out List; 
                           And_The_List       : in out List);
    ...
    procedure Insert      (The_List           : in     List; 
                           After_The_List     : in out List);
