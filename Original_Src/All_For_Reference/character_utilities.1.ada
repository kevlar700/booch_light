...
package Character_Utilities is
    ...
    function Uppercase       (The_Character : in Character) return Character;
    function Lowercase       (The_Character : in Character) return Character;
    ...
    function Is_Equal        (Left           : in Character; 
                              ...
                              return              Boolean;
    function Is_Less_Than    (Left           : in Character; 
                              Right          : in Character; 
                              Case_Sensitive : in Boolean := True) 
                              return              Boolean;
    function Is_Greater_Than (Left           : in Character; 
                              Right          : in Character; 
                              Case_Sensitive : in Boolean := True) 
                              return              Boolean;
