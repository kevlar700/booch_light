...
package body Set_Simple_Concurrent_Unbounded_Unmanaged_Iterator is
    ...
    begin
        Seize (From_The_Set);
        Seize (To_The_Set);
        From_Index := From_The_Set.The_Items;
        if From_The_Set.The_Items = null then
            To_The_Set.The_Items := null;
        else
            To_The_Set.The_Items :=
    ...
    begin
        ...
        To_The_Set.The_Items := new Node'(The_Item => The_Item,
                                          Next => To_The_Set.The_Items);
        Release (To_The_Set);
    exception
        when Storage_Error =>
            Release (To_The_Set);
    ...
    begin
        ...
        Seize (And_The_Set);
        Seize (To_The_Set);
        From_Index := Of_The_Set.The_Items;
        To_The_Set.The_Items := null;
        while From_Index /= null loop
            To_The_Set.The_Items := new Node'(The_Item => From_Index.The_Item,
                                              Next => To_The_Set.The_Items);
            From_Index := From_Index.Next;
        end loop;
    ...
    begin
        ...
        while Of_Index /= null loop
            ...
            if And_Index = null then
                To_The_Set.The_Items := new Node'(The_Item => Of_Index.The_Item,
                                                  Next => To_The_Set.The_Items);
            end if;
            Of_Index := Of_Index.Next;
        end loop;
    ...
    begin
        Seize (Over_The_Set);
        The_Iterator := Over_The_Set.The_Items;
...
end Set_Simple_Concurrent_Unbounded_Unmanaged_Iterator;
