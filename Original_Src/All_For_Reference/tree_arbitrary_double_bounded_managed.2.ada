...
package body Tree_Arbitrary_Double_Bounded_Managed is
        ...
        if Number_Of_Children = 0 then
            ...
            for Index in 1 .. Number_Of_Children loop
                Children.Bind (The_Domain => Index,
                               ...
                               In_The_Map => Heap (And_The_Tree.The_Head).
                                                The_Children);
            end loop;
    ...
    begin
        if And_The_Tree = Null_Tree then
            ...
            Children.Unbind (The_Child,
                             Heap (Of_The_Tree.The_Head).The_Children);
            Children.Bind (The_Domain => The_Child,
                           And_The_Range => Null_Tree,
                           In_The_Map => Heap (Of_The_Tree.The_Head).
                                            The_Children);
            if Temporary_Node /= Null_Tree then
