...
generic
    ...
    with procedure Initialize (The_Iterator    : in out Iterator;
                               With_The_Vertex : in     Vertex);
    with procedure Get_Next   (The_Iterator    : in out Iterator);
    with function Number_Of_Arcs_From (The_Vertex : in Vertex) return Natural;
...
package Graph_Utilities_Directed is

    function Is_Terminal   (The_Vertex : in Vertex) return Boolean;
    function Has_Self_Loop (The_Vertex : in Vertex) return Boolean;

end Graph_Utilities_Directed;
