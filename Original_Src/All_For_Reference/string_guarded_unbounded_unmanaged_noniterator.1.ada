...
package String_Guarded_Unbounded_Unmanaged_Noniterator is

    type String is limited private;

    procedure Seize    (The_String         : in     String);
    procedure Release  (The_String         : in     String);
...
end String_Guarded_Unbounded_Unmanaged_Noniterator;
