...
package body Deque_Nonpriority_Balking_Concurrent_Unbounded_Unmanaged_Iterator is
    ...
    begin
        ...
        Release (Over_The_Deque);
    end Iterate;

end Deque_Nonpriority_Balking_Concurrent_Unbounded_Unmanaged_Iterator;
