...
package body Set_Discrete_Guarded_Bounded_Managed_Iterator is
    ...
    begin
        return (Left.The_Items = Right.The_Items);
    end Is_Equal;
    ...
    function Is_A_Subset (Left : in Set; Right : in Set) return Boolean is
        Intersection_Set : Items := Left.The_Items and Right.The_Items;
    begin
        return (Left.The_Items = Intersection_Set);
    end Is_A_Subset;
    ...
    function Is_A_Proper_Subset
        ...
        Intersection_Set : Items := Left.The_Items and Right.The_Items;
    begin
        return ((Intersection_Set = Left.The_Items) and then
...
end Set_Discrete_Guarded_Bounded_Managed_Iterator;
