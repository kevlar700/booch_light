...
package body Graph_Directed_Bounded_Managed is
    ...
    procedure Copy (From_The_Graph : in Graph; To_The_Graph : in out Graph) is
        ...
        procedure Visit (The_Vertex : in Vertex; Continue : out Boolean) is
            ...
            begin
                ...
                Arc_Heap (Temporary_Arc.The_Head).The_Source :=
                   Temporary_Vertex;
                Visit (Arc_Heap (The_Arc.The_Head).The_Destination, Continue);
                Arc_Heap (Temporary_Arc.The_Head).The_Destination :=
                   Vertex_Map.Range_Of
                      (Arc_Heap (The_Arc.The_Head).The_Destination,
                       Vertices_Visited);
                Arc_Set.Add (Temporary_Arc,
                             Vertex_Heap (Temporary_Vertex.The_Head).The_Arcs);
        ...
        begin
            Vertex_Heap (Arc_Heap (The_Arc.The_Head).The_Destination.The_Head).
               ...
               Vertex_Heap (Arc_Heap (The_Arc.The_Head).
                            The_Destination.The_Head).Reference_Count - 1;
    ...
    begin
        if (From_The_Vertex = Null_Vertex) or else
           (To_The_Vertex = Null_Vertex) then
            ...
            Arc_Set.Add (The_Arc,
                         Vertex_Heap (From_The_Vertex.The_Head).The_Arcs);
    ...
    begin
        if The_Arc = Null_Arc then
            ...
            Arc_Set.Remove
               (The_Arc, Vertex_Heap
                            (Arc_Heap (The_Arc.The_Head).The_Source.The_Head).
                         The_Arcs);
            if Arc_Heap (The_Arc.The_Head).The_Source /=
               Arc_Heap (The_Arc.The_Head).The_Destination then
                Vertex_Heap (Arc_Heap (The_Arc.The_Head).
                             The_Destination.The_Head).Reference_Count :=
                   Vertex_Heap (Arc_Heap (The_Arc.The_Head).
                                The_Destination.The_Head).Reference_Count - 1;
            end if;
    ...
    begin
        return Arc_Heap (The_Arc.The_Head).The_Source;
    exception
        when Constraint_Error =>
            raise Arc_Is_Null;
    end Source_Of;
    ...
    begin
        return Arc_Heap (The_Arc.The_Head).The_Destination;
    exception
        when Constraint_Error =>
            raise Arc_Is_Null;
    end Destination_Of;
