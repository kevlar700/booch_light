...
package body Topological_Sort_Unbounded_Unmanaged is

    package Node_Set is
       new Set_Simple_Sequential_Unbounded_Unmanaged_Iterator (Positive);
...
end Topological_Sort_Unbounded_Unmanaged;
