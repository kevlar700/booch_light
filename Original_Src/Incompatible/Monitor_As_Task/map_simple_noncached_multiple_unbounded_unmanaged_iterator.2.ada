...
package body Map_Simple_Noncached_Multiple_Unbounded_Unmanaged_Iterator is
    ...
    procedure Seize_For_Reading (The_Map : in Map) is
    begin
        Monitor.Start_Reading (The_Map.Guard);
    end Seize_For_Reading;

    procedure Release_For_Reading (The_Map : in Map) is
    begin
        Monitor.Stop_Reading (The_Map.Guard);
    end Release_For_Reading;

    procedure Seize_For_Writing (The_Map : in Map) is
    begin
        Monitor.Start_Writing (The_Map.Guard);
    end Seize_For_Writing;

    procedure Release_For_Writing (The_Map : in Map) is
    begin
        Monitor.Stop_Writing (The_Map.Guard);
    ...
    procedure Copy (From_The_Map : in Map; To_The_Map : in out Map) is
        ...
        To_Index : Structure;
    begin
        Seize_For_Reading (From_The_Map);
        Seize_For_Writing (To_The_Map);
        ...
        Release_For_Reading (From_The_Map);
        Release_For_Writing (To_The_Map);
    exception
        when Storage_Error =>
            Release_For_Reading (From_The_Map);
            Release_For_Writing (To_The_Map);
    ...
    begin
        Seize_For_Writing (The_Map);
        The_Map.The_Items := Items'(others => null);
        Release_For_Writing (The_Map);
    end Clear;
    ...
    function Is_Bound
        ...
        Current_Node : Structure;
    begin
        Seize_For_Reading (In_The_Map);
        Find (The_Domain, In_The_Map, The_Bucket, Previous_Node, Current_Node);
        Release_For_Reading (In_The_Map);
    ...
    procedure Iterate (Over_The_Map : in Map) is
        ...
        Continue : Boolean;
    begin
        Seize_For_Reading (Over_The_Map);
        ...
        Release_For_Reading (Over_The_Map);
    end Iterate;

end Map_Simple_Noncached_Multiple_Unbounded_Unmanaged_Iterator;
