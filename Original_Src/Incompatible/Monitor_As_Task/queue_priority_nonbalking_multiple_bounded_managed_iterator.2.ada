...
package body Queue_Priority_Nonbalking_Multiple_Bounded_Managed_Iterator is
    ...
    begin
        ...
        if To_The_Queue.The_Back = 0 then
            ...
            if Index > To_The_Queue.The_Back then
                ...
                To_The_Queue.The_Items ((Index + 1) ..
                                           (To_The_Queue.The_Back + 1)) :=
                   To_The_Queue.The_Items (Index .. To_The_Queue.The_Back);
    ...
    procedure Iterate (Over_The_Queue : in Queue) is
        Continue : Boolean;
    begin
        Seize_For_Reading (Over_The_Queue);
        for The_Iterator in 1 .. Over_The_Queue.The_Back loop
            Process (Over_The_Queue.The_Items (The_Iterator), Continue);
            exit when not Continue;
        end loop;
        Release_For_Reading (Over_The_Queue);
    end Iterate;

end Queue_Priority_Nonbalking_Multiple_Bounded_Managed_Iterator;
