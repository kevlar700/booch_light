...
package body Bag_Simple_Concurrent_Unbounded_Managed_Iterator is
    ...
    begin
        Seize (Over_The_Bag);
        The_Iterator := Over_The_Bag.The_Items;
        ...
        Release (Over_The_Bag);
    end Iterate;

end Bag_Simple_Concurrent_Unbounded_Managed_Iterator;
