...
package body Bag_Simple_Guarded_Unbounded_Managed_Iterator is
    ...
    procedure Seize (The_Bag : in Bag) is
    begin
        Semaphore.Seize (The_Bag.Guard);
    end Seize;

    procedure Release (The_Bag : in Bag) is
    begin
        Semaphore.Release (The_Bag.Guard);
    end Release;

    procedure Copy (From_The_Bag : in Bag; To_The_Bag : in out Bag) is
        From_Index : Structure := From_The_Bag.The_Items;
        To_Index : Structure;
    begin
        Node_Manager.Free (To_The_Bag.The_Items);
        if From_The_Bag.The_Items /= null then
            To_The_Bag.The_Items := Node_Manager.New_Item;
            To_The_Bag.The_Items.The_Item := From_Index.The_Item;
            To_The_Bag.The_Items.The_Count := From_Index.The_Count;
    ...
    begin
        ...
        Temporary_Node.Next := To_The_Bag.The_Items;
        To_The_Bag.The_Items := Temporary_Node;
    exception
        when Storage_Error =>
            raise Overflow;
    end Add;
    ...
    procedure Remove (The_Item : in Item; From_The_Bag : in out Bag) is
        Previous : Structure;
        Index : Structure := From_The_Bag.The_Items;
    begin
        while Index /= null loop
            if Index.The_Item = The_Item then
    ...
    procedure Union (Of_The_Bag : in Bag;
        ...
        From_Index : Structure := Of_The_Bag.The_Items;
        To_Index : Structure;
        To_Top : Structure;
        Temporary_Node : Structure;
    begin
    ...
    procedure Intersection (Of_The_Bag : in Bag;
                            And_The_Bag : in Bag;
                            To_The_Bag : in out Bag) is
        Of_Index : Structure := Of_The_Bag.The_Items;
        And_Index : Structure;
        Temporary_Node : Structure;
    begin
        Node_Manager.Free (To_The_Bag.The_Items);
            ...
            while And_Index /= null loop
                if Of_Index.The_Item = And_Index.The_Item then
                    ...
                    if Of_Index.The_Count < And_Index.The_Count then
                        ...
                        Temporary_Node.The_Count := And_Index.The_Count;
                    end if;
                    Temporary_Node.Next := To_The_Bag.The_Items;
                    To_The_Bag.The_Items := Temporary_Node;
                    exit;
        ...
        while Of_Index /= null loop
            ...
            if And_Index = null then
                ...
                Temporary_Node.The_Count :=
                   Of_Index.The_Count - And_Index.The_Count;
                Temporary_Node.Next := To_The_Bag.The_Items;
                To_The_Bag.The_Items := Temporary_Node;
            end if;
            Of_Index := Of_Index.Next;
    ...
    function Extent_Of (The_Bag : in Bag) return Natural is
        Count : Natural := 0;
        Index : Structure := The_Bag.The_Items;
    begin
        while Index /= null loop
    ...
    function Number_Of
        ...
        Index : Structure := In_The_Bag.The_Items;
    begin
        while Index /= null loop
    ...
    procedure Iterate (Over_The_Bag : in Bag) is
        The_Iterator : Structure := Over_The_Bag.The_Items;
        Continue : Boolean;
    begin
        while The_Iterator /= null loop
            Process (The_Iterator.The_Item, The_Iterator.The_Count, Continue);
            exit when not Continue;
            The_Iterator := The_Iterator.Next;
        end loop;
    end Iterate;

end Bag_Simple_Guarded_Unbounded_Managed_Iterator;
