...
package body Set_Simple_Guarded_Unbounded_Unmanaged_Iterator is
    ...
    procedure Iterate (Over_The_Set : in Set) is
        The_Iterator : Structure := Over_The_Set.The_Items;
        Continue : Boolean;
    begin
...
end Set_Simple_Guarded_Unbounded_Unmanaged_Iterator;
