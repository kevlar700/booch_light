...
package body Bag_Simple_Concurrent_Bounded_Managed_Iterator is
    ...
    begin
        ...
        for Index in 1 .. In_The_Bag.The_Back loop
            if The_Item = In_The_Bag.The_Items (Index).The_Item then
                Result := In_The_Bag.The_Items (Index).The_Count;
                Release (In_The_Bag);
                return Result;
            end if;
        end loop;
...
end Bag_Simple_Concurrent_Bounded_Managed_Iterator;
