...
package body List_Double_Unbounded_Controlled is
    ...
    procedure Share (The_List : in List; With_The_List : in out List) is
    begin
    ...
    function Is_Shared (Left : in List; Right : in List) return Boolean is
    begin
        return (Left = Right);
    end Is_Shared;
...
end List_Double_Unbounded_Controlled;
