...
with Set_Simple_Sequential_Unbounded_Controlled_Iterator,
     Queue_Nonpriority_Nonbalking_Sequential_Unbounded_Controlled_Noniterator;
package body Topological_Sort_Unbounded_Controlled is

    package Node_Set is
       new Set_Simple_Sequential_Unbounded_Controlled_Iterator (Positive);
