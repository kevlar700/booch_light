...
package Graph_Search_Unbounded_Controlled is

    generic
        with procedure Process (The_Vertex : in  Vertex; 
                                Continue   : out Boolean);
    procedure Traverse_Depth_First (From_The_Vertex : in Vertex);

    generic
        with procedure Process (The_Vertex : in  Vertex; 
                                Continue   : out Boolean);
    procedure Traverse_Breadth_First (From_The_Vertex : in Vertex);
